...
def generating_target(y):
    y = y.copy()
    # adding new skipped column and dropping skip_1, skip_2 and skip_3
    y["skipped"] = y["skip_1"]*y["skip_2"]*y["skip_3"]
    y.drop(labels=["skip_1", "skip_2", "skip_3", "not_skipped"], inplace=True, axis=1)
    y["skipped"] = y["skipped"].astype("int32")
    return y